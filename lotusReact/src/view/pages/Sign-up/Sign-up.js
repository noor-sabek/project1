...
import SignUpOptions from './signWith.js'
import './signUp.css';
      ...
      <div className=" container col-8 style pt-4">
         ...
         <div className=" pb_text_align_left" >
               ...
               <div className="w3-panel w3-leftbar w3-sand">
                        <h1 className="text-center title mt-5 py-5 w3-serif">Rigestration  </h1>
         ...
         <div className="et_pb_newsletter_form et_pb_login_form  mt- block-item left">
